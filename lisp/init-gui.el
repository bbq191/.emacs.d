;; init-gui.el --- Initialize compant configurations. -*- lexical-binding: t -*-
;;; Commentary: Visual (UI) configurations for better lookings and appearances.
...
;; Title
(setq frame-title-format '("iKatemacs - %b")
...
;; Theme
(if (compatible-theme-p my-theme)
    (progn
...
(use-package doom-modeline
  ...
  :init
  (setq doom-modeline-icon my-icon
...
;; Ligatures support
(when (and emacs/>=28p (not prettify-symbols-alist))
